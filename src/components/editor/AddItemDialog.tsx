...
export function AddItemDialog({ onAdd, trigger }: AddItemDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[560px] max-sm:w-[calc(100vw-1rem)] rounded-3xl border border-zinc-200/80 bg-zinc-50/96 p-0 overflow-hidden backdrop-blur-2xl dark:border-white/12 dark:bg-zinc-950/93">
        <DialogTitle className="sr-only">Add New Item</DialogTitle>
        <div className="flex max-h-[min(100dvh-1rem,48rem)] min-h-0 flex-col">
          <div className="min-h-0 flex-1 overflow-y-auto px-8 pb-6 pt-10 max-sm:px-5 max-sm:pb-5 max-sm:pt-6">
            <DialogHeader className="space-y-5 items-start text-left">
              ...
              <div className="space-y-1.5">
                <DialogTitle className="text-2xl font-black tracking-tight max-sm:text-[1.35rem]">Add New Item</DialogTitle>
