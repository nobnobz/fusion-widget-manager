              ...
              <div className="flex-1 flex items-center min-w-0">
                <CatalogCombobox 
                  ...
                  trigger={
                    <button
                      type="button"
                      className="flex-1 flex items-center justify-between gap-3 px-3.5 h-11 rounded-xl border border-zinc-200/60 bg-white/70 dark:border-white/10 dark:bg-zinc-900/40 hover:border-primary/30 hover:bg-primary/[0.03] dark:hover:bg-primary/[0.05] transition-all text-left outline-none group/source shadow-[0_1px_2px_rgba(0,0,0,0.02)]"
                    >
